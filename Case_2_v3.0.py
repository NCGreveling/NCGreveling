...
df_dropdown = results_df[results_df['Position'] == 1].sort_values('Time_(ms)')
df_dropdown = df_dropdown[df_dropdown['Race_Name']=='British Grand Prix']
fig = go.Figure(data=go.Scatter(x=df_dropdown["Season"],
                                y=df_dropdown['Time_(ms)'],
                                mode='markers'))
...
df_dropdown = results_df[results_df['Position']].sort_values('Time_(ms)')
df_dropdown = df_dropdown[df_dropdown['Race_Name']=='British Grand Prix']
fig = go.Figure(data=go.Histogram(x=df_dropdown["Season"],
                                y=df_dropdown['Time_(ms)'],
                                mode='markers'))
